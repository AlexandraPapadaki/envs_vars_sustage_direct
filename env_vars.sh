...
export REPO_PATH=/home/sustage/Codes/directml2/repository  # Folder for the EPOS repository.
export STORE_PATH=/home/sustage/Codes/directml2/store  # Folder for TFRecord files and trained models.
export BOP_PATH=/home/sustage/Codes/directml2/datasets  # Folder for BOP datasets (bop.felk.cvut.cz/datasets).
